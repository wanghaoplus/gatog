                        ...
                        <div class="col-sm-6 b-r" style="height:200px">
                            <form class="form-horizontal">
                                <div class="form-group">
                                    <label class="col-sm-2 control-label text-info">任务编号:</label>
                                    <div class="col-sm-5">
                                        <span class="form-control" id="taskId">{taskId}</span>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label text-info">开始时间:</label>
                                    <div class="col-sm-5">
                                        <span class="form-control" id="startTime">{startTime}</span>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label text-info">结束时间:</label>
                                    <div class="col-sm-5">
                                        <span class="form-control" id="endTime">{endTime}</span>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label text-info">运行时间:</label>
                                    <div class="col-sm-5">
                                        <span class="form-control" id="totalTime">{totalTime}</span>
                                    </div>
                                </div>
                            </form>
                        </div>
                        <div class="col-sm-6 b-r" style="height:200px">
                            <form class="form-horizontal">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                        <span class="form-control" id="testAll">{testAll}</span>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label text-navy">用例通过:</label>
                                    <div class="col-sm-5">
                                        <span class="form-control" id="testPass">{testPass}</span>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label text-danger">用例失败:</label>
                                    <div class="col-sm-5">
                                        <span class="form-control text-danger" id="testFail">{testFail}</span>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label text-warning">无效用例:</label>
                                    <div class="col-sm-5">
                                        <span class="form-control text-warning" id="testBlock">{testBlock}</span>
                                    </div>
                                </div>
                            </form>
                        </div>
...
DETAIL_DATA_FILTER = '''
                    <div class="input-group panel-heading" style="width: 100%; background-color: {backgroundColor}; margin-bottom: 10px; text-align: left; font-family: Consolas;">
                        <label style="color: snow">用例编号:</label>
                        <select class="chosen-select form-control" data-placeholder="ALL" style="width: 300px;" name="filterClass" id="filterClass">
                            <option value="">ALL</option>
                        </select>
                        <label style="color: snow;margin-left: 10px;">测试结果:</label>
...
DETAIL_BODY_CONTENT = '''
                        <tr>
                            ...
                            <td>{totalTime}</td>
                            <td>{testResult}</td>
                            <td onclick="window.open('{caseLog}');">查看</td>
                            <td onclick="window.open('{kpiReport}');">查看</td>
                        </tr>'''

DETAIL_SUMMARY_LABLE = '''
                            <label>
                                <span class="text-info">用例数: </span><span class="text-info" id="filterAll">{filterAll}</span><span> | </span>
                                <span class="text-success">成功: </span><span class="text-success" id="filterOk">{filterOk}</span><span> | </span>
                                <span class="text-danger">失败: </span><span class="text-danger" id="filterFail">{filterFail}</span><span> | </span>
                                <span class="text-warning">无效: </span><span class="text-warning" id="filterBlock">{filterBlock}</span>
                            </label>'''
