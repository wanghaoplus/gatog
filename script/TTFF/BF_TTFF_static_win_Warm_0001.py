...
class BF_TTFF_static_win_Warm_0001(LbsTestCase):

    def __init__(self):
        super(BF_TTFF_static_win_Warm_0001, self).__init__()
        self.TestCaseList = ["BF_TTFF_static_win_Warm_0001"]

    def setup(self):
        super(BF_TTFF_static_win_Warm_0001, self).setup()
        self.latRef = 22.6325521803272
        self.lonRef = 114.064212917882
        self.altRef = 94.6353411981836
        
    def BF_TTFF_static_win_Warm_0001(self):
    ...
    def teardown(self):
        super(BF_TTFF_static_win_Warm_0001, self).teardown()
