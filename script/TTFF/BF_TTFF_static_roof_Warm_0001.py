...
class BF_TTFF_static_roof_Warm_0001(LbsTestCase):

    def __init__(self):
        super(BF_TTFF_static_roof_Warm_0001, self).__init__()
        self.TestCaseList = ["BF_TTFF_static_roof_Warm_0001"]

    def setup(self):
        super(BF_TTFF_static_roof_Warm_0001, self).setup()
        self.latRef = 22.6324465
        self.lonRef = 114.0637045
        self.altRef = 117.1
        
    def BF_TTFF_static_roof_Warm_0001(self):
    ...
    def teardown(self):
        super(BF_TTFF_static_roof_Warm_0001, self).teardown()
