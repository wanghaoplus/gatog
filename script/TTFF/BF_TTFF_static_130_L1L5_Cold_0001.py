...
class BF_TTFF_static_130_L1L5_Cold_0001(LbsTestCase):

    def __init__(self):
        super(BF_TTFF_static_130_L1L5_Cold_0001, self).__init__()
        self.TestCaseList = ["BF_TTFF_static_130_L1L5_Cold_0001"]
        self.scenePath = ""

    def setup(self):
        super(BF_TTFF_static_130_L1L5_Cold_0001, self).setup()  
    ...
    def BF_TTFF_static_130_L1L5_Cold_0001(self):
    ...
    def teardown(self):
        super(BF_TTFF_static_130_L1L5_Cold_0001, self).teardown()
