...
# @Author  : wanghao
# @Site    : 
# @File    : BF_TTFF_static_130_L1L5_Hot_0001.py
# @Software: Eclipse

from aw.LbsTestCase import LbsTestCase


class BF_TTFF_static_130_L1L5_Hot_0001(LbsTestCase):

    def __init__(self):
        super(BF_TTFF_static_130_L1L5_Hot_0001, self).__init__()
        self.TestCaseList = ["BF_TTFF_static_130_L1L5_Hot_0001"]
        self.scenePath = ""
        
    def setup(self):
        super(BF_TTFF_static_130_L1L5_Hot_0001, self).setup()
    ...
    def teardown(self):
        super(BF_TTFF_static_130_L1L5_Hot_0001, self).teardown()
