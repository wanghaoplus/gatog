...
class AGNSS_Test_0043(LbsTestCase):

    def __init__(self):
        super(AGNSS_Test_0043, self).__init__()
        self.TestCaseList = ["AGNSS_Test_0043"]

    def setup(self):
        self.setupStep('labsat')
        super(AGNSS_Test_0043, self).setup()
        self.aw_initLabsat()
