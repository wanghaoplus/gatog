...
class AGNSS_Test_0036(LbsTestCase):

    def __init__(self):
        super(AGNSS_Test_0036, self).__init__()
        self.TestCaseList = ["AGNSS_Test_0036"]

    def setup(self):
        self.setupStep('labsat')
        super(AGNSS_Test_0036, self).setup()
        self.aw_initLabsat()
