...
class AGNSS_Test_0116(LbsTestCase):

    def __init__(self):
        super(AGNSS_Test_0116, self).__init__()
        self.TestCaseList = ["AGNSS_Test_0116"]

    def setup(self):
        self.setupStep('labsat')
        super(AGNSS_Test_0116, self).setup()
        self.aw_initLabsat()
