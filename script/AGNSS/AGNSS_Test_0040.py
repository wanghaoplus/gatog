...
class AGNSS_Test_0040(LbsTestCase):

    def __init__(self):
        super(AGNSS_Test_0040, self).__init__()
        self.TestCaseList = ["AGNSS_Test_0040"]

    def setup(self):
        self.setupStep('labsat')
        super(AGNSS_Test_0040, self).setup()
        self.aw_initLabsat()
