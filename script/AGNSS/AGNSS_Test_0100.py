...
class AGNSS_Test_0100(LbsTestCase):

    def __init__(self):
        super(AGNSS_Test_0100, self).__init__()
        self.TestCaseList = ["AGNSS_Test_0100"]

    def setup(self):
        self.setupStep('labsat')
        super(AGNSS_Test_0100, self).setup()
        self.aw_initLabsat()
