...
class AGNSS_Test_0089(LbsTestCase):

    def __init__(self):
        super(AGNSS_Test_0089, self).__init__()
        self.TestCaseList = ["AGNSS_Test_0089"]

    def setup(self):
        self.setupStep('labsat')
        super(AGNSS_Test_0089, self).setup()
        self.aw_initLabsat()
