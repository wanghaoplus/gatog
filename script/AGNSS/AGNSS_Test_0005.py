...
class AGNSS_Test_0005(LbsTestCase):

    def __init__(self):
        super(AGNSS_Test_0005, self).__init__()
        self.TestCaseList = ["AGNSS_Test_0005"]

    def setup(self):
        self.setupStep('labsat')
        super(AGNSS_Test_0005, self).setup()
        self.aw_initLabsat()
