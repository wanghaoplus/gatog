...
class AGNSS_Test_0048(LbsTestCase):

    def __init__(self):
        super(AGNSS_Test_0048, self).__init__()
        self.TestCaseList = ["AGNSS_Test_0048"]

    def setup(self):
        self.setupStep('labsat')
        super(AGNSS_Test_0048, self).setup()
        self.aw_initLabsat()
