...
class AGNSS_Test_0015(LbsTestCase):

    def __init__(self):
        super(AGNSS_Test_0015, self).__init__()
        self.TestCaseList = ["AGNSS_Test_0015"]

    def setup(self):
        self.setupStep('labsat')
        super(AGNSS_Test_0015, self).setup()
        self.aw_initLabsat()
