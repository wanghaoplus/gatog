...
class AGNSS_Test_0076(LbsTestCase):

    def __init__(self):
        super(AGNSS_Test_0076, self).__init__()
        self.TestCaseList = ["AGNSS_Test_0076"]

    def setup(self):
        self.setupStep('labsat')
        super(AGNSS_Test_0076, self).setup()
        self.aw_initLabsat()
