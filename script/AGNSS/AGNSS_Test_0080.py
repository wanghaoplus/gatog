...
class AGNSS_Test_0080(LbsTestCase):

    def __init__(self):
        super(AGNSS_Test_0080, self).__init__()
        self.TestCaseList = ["AGNSS_Test_0080"]

    def setup(self):
        self.setupStep('labsat')
        super(AGNSS_Test_0080, self).setup()
        self.aw_initLabsat()
