...
class AGNSS_Test_0147(LbsTestCase):

    def __init__(self):
        super(AGNSS_Test_0147, self).__init__()
        self.TestCaseList = ["AGNSS_Test_0147"]

    def setup(self):
        self.setupStep('labsat')
        super(AGNSS_Test_0147, self).setup()
        self.aw_initLabsat()
