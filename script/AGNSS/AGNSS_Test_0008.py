...
class AGNSS_Test_0008(LbsTestCase):

    def __init__(self):
        super(AGNSS_Test_0008, self).__init__()
        self.TestCaseList = ["AGNSS_Test_0008"]

    def setup(self):
        self.setupStep('labsat')
        super(AGNSS_Test_0008, self).setup()
        self.aw_initLabsat()
