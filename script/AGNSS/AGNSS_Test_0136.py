...
class AGNSS_Test_0136(LbsTestCase):

    def __init__(self):
        super(AGNSS_Test_0136, self).__init__()
        self.TestCaseList = ["AGNSS_Test_0136"]

    def setup(self):
        self.setupStep('labsat')
        super(AGNSS_Test_0136, self).setup()
        self.aw_initLabsat()
