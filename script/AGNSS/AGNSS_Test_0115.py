...
class AGNSS_Test_0115(LbsTestCase):

    def __init__(self):
        super(AGNSS_Test_0115, self).__init__()
        self.TestCaseList = ["AGNSS_Test_0115"]

    def setup(self):
        self.setupStep('labsat')
        super(AGNSS_Test_0115, self).setup()
        self.aw_initLabsat()
