...
class AGNSS_Test_0072(LbsTestCase):

    def __init__(self):
        super(AGNSS_Test_0072, self).__init__()
        self.TestCaseList = ["AGNSS_Test_0072"]

    def setup(self):
        self.setupStep('labsat')
        super(AGNSS_Test_0072, self).setup()
        self.aw_initLabsat()
