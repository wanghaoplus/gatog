...
class AGNSS_Test_0098(LbsTestCase):

    def __init__(self):
        super(AGNSS_Test_0098, self).__init__()
        self.TestCaseList = ["AGNSS_Test_0098"]

    def setup(self):
        self.setupStep('labsat')
        super(AGNSS_Test_0098, self).setup()
        self.aw_initLabsat()
