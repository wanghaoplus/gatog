...
class AGNSS_Test_0006(LbsTestCase):

    def __init__(self):
        super(AGNSS_Test_0006, self).__init__()
        self.TestCaseList = ["AGNSS_Test_0006"]

    def setup(self):
        self.setupStep('labsat')
        super(AGNSS_Test_0006, self).setup()
        self.aw_initLabsat()
