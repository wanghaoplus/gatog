...
class BF_TTFF_static_win_Cold_0002(LbsTestCase):

    def __init__(self):
        super(BF_TTFF_static_win_Cold_0002, self).__init__()
        self.TestCaseList = ["BF_TTFF_static_win_Cold_0002"]

    def setup(self):
        super(BF_TTFF_static_win_Cold_0002, self).setup()
        self.aw_initLabsat()
    ...
    def BF_TTFF_static_win_Cold_0002(self):
    ...
    def teardown(self):
        super(BF_TTFF_static_win_Cold_0002, self).teardown()
