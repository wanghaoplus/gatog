...
# @Author  : wangdelei
# @Site    : 
# @File    : BF_Dynamic_TTFF_Car_Reacq_0003.py
# @Software: PyCharm
...
class BF_Dynamic_TTFF_Car_Reacq_0003(LbsTestCase):

    def __init__(self):
        super(BF_Dynamic_TTFF_Car_Reacq_0003, self).__init__()
        self.TestCaseList = ["BF_Dynamic_TTFF_Car_Reacq_0003"]

    def setup(self):
        self.setupStep('labsat')
        super(BF_Dynamic_TTFF_Car_Reacq_0003, self).setup()
        self.aw_initLabsat()
    ...
    def BF_Dynamic_TTFF_Car_Reacq_0003(self):
        self.testStep("开始测试")
