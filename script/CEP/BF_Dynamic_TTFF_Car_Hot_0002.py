...
# @Author  : wangdelei
# @Site    : 
# @File    : BF_Dynamic_TTFF_Car_Hot_0002.py
# @Software: PyCharm
...
class BF_Dynamic_TTFF_Car_Hot_0002(LbsTestCase):

    def __init__(self):
        super(BF_Dynamic_TTFF_Car_Hot_0002, self).__init__()
        self.TestCaseList = ["BF_Dynamic_TTFF_Car_Hot_0002"]

    def setup(self):
        self.setupStep('labsat')
        super(BF_Dynamic_TTFF_Car_Hot_0002, self).setup()
        self.aw_initLabsat()
    ...
    def BF_Dynamic_TTFF_Car_Hot_0002(self):
        self.testStep("开始测试")
