...
class BF_TTFF_static_roof_powerall_0004(LbsTestCase):

    def __init__(self):
        super(BF_TTFF_static_roof_powerall_0004, self).__init__()
        self.TestCaseList = ["BF_TTFF_static_roof_powerall_0004"]

    def setup(self):
        super(BF_TTFF_static_roof_powerall_0004, self).setup()
        self.aw_initLabsat()
    ...
    def BF_TTFF_static_roof_powerall_0004(self):
    ...
    def teardown(self):
        super(BF_TTFF_static_roof_powerall_0004, self).teardown()
