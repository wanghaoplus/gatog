...
class BF_FieldTest_Car_0004(LbsTestCase):

    def __init__(self):
        super(BF_FieldTest_Car_0004, self).__init__()
        self.TestCaseList = ["BF_FieldTest_Car_0004"]

    def setup(self):
        self.setupStep('labsat')
        super(BF_FieldTest_Car_0004, self).setup()
        self.aw_initLabsat()
    ...
    def BF_FieldTest_Car_0004(self):
        self.testStep("开始测试")
