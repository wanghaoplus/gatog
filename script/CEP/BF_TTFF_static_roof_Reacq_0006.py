...
class BF_TTFF_static_roof_Reacq_0006(LbsTestCase):

    def __init__(self):
        super(BF_TTFF_static_roof_Reacq_0006, self).__init__()
        self.TestCaseList = ["BF_TTFF_static_roof_Reacq_0006"]

    def setup(self):
        super(BF_TTFF_static_roof_Reacq_0006, self).setup()
        self.aw_initLabsat()
    ...
    def BF_TTFF_static_roof_Reacq_0006(self):
        ...
        for i in range(1, 31):
            ...
            self.lbs.aw_checkLocationSuccess(120)
    ...
    def teardown(self):
        super(BF_TTFF_static_roof_Reacq_0006, self).teardown()
