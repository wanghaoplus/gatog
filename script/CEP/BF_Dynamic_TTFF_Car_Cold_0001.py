...
# @Author  : wangdelei
# @Site    : 
# @File    : BF_Dynamic_TTFF_Car_Cold_0001.py
# @Software: PyCharm
...
class BF_Dynamic_TTFF_Car_Cold_0001(LbsTestCase):

    def __init__(self):
        super(BF_Dynamic_TTFF_Car_Cold_0001, self).__init__()
        self.TestCaseList = ["BF_Dynamic_TTFF_Car_Cold_0001"]

    def setup(self):
        self.setupStep('labsat')
        super(BF_Dynamic_TTFF_Car_Cold_0001, self).setup()
        self.aw_initLabsat()
    ...
    def BF_Dynamic_TTFF_Car_Cold_0001(self):
        self.testStep("开始测试")
