...
# @Author  : wangdelei
# @Site    : 
# @File    : BF_stable_CEP_roof_0001.py
# @Software: PyCharm
...
class BF_stable_CEP_roof_0001(LbsTestCase):

    def __init__(self):
        super(BF_stable_CEP_roof_0001, self).__init__()
        self.TestCaseList = ["BF_stable_CEP_roof_0001"]

    def setup(self):
        self.setupStep('labsat')
        super(BF_stable_CEP_roof_0001, self).setup()
        self.aw_initLabsat()
    ...
    def BF_stable_CEP_roof_0001(self):
        self.testStep("开始测试")
