...
class BF_TTFF_static_win_warm_0003(LbsTestCase):

    def __init__(self):
        super(BF_TTFF_static_win_warm_0003, self).__init__()
        self.TestCaseList = ["BF_TTFF_static_win_warm_0003"]

    def setup(self):
        super(BF_TTFF_static_win_warm_0003, self).setup()
        self.aw_initLabsat()
    ...
    def BF_TTFF_static_win_warm_0003(self):
    ...
    def teardown(self):
        super(BF_TTFF_static_win_warm_0003, self).teardown()
