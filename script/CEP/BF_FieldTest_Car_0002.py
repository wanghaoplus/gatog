...
class BF_FieldTest_Car_0002(LbsTestCase):

    def __init__(self):
        super(BF_FieldTest_Car_0002, self).__init__()
        self.TestCaseList = ["BF_FieldTest_Car_0002"]

    def setup(self):
        self.setupStep('labsat')
        super(BF_FieldTest_Car_0002, self).setup()
        self.aw_initLabsat()
    ...
    def BF_FieldTest_Car_0002(self):
        self.testStep("开始测试")
