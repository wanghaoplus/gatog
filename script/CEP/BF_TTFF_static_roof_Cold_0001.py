...
class BF_TTFF_static_roof_Cold_0001(LbsTestCase):

    def __init__(self):
        super(BF_TTFF_static_roof_Cold_0001, self).__init__()
        self.TestCaseList = ["BF_TTFF_static_roof_Cold_0001"]

    def setup(self):
        super(BF_TTFF_static_roof_Cold_0001, self).setup()
        self.aw_initLabsat()
    ...
    def BF_TTFF_static_roof_Cold_0001(self):
    ...
    def teardown(self):
        super(BF_TTFF_static_roof_Cold_0001, self).teardown()
