...
class BF_TTFF_static_win_powermain_0005(LbsTestCase):

    def __init__(self):
        super(BF_TTFF_static_win_powermain_0005, self).__init__()
        self.TestCaseList = ["BF_TTFF_static_win_powermain_0005"]

    def setup(self):
        super(BF_TTFF_static_win_powermain_0005, self).setup()
        self.aw_initLabsat()
    ...
    def BF_TTFF_static_win_powermain_0005(self):
    ...
    def teardown(self):
        super(BF_TTFF_static_win_powermain_0005, self).teardown()
