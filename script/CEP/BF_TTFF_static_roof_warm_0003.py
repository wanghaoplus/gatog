...
class BF_TTFF_static_roof_Reacq_0003(LbsTestCase):

    def __init__(self):
        super(BF_TTFF_static_roof_Reacq_0003, self).__init__()
        self.TestCaseList = ["BF_TTFF_static_roof_Reacq_0003"]

    def setup(self):
        super(BF_TTFF_static_roof_Reacq_0003, self).setup()
        self.aw_initLabsat()
    ...
    def BF_TTFF_static_roof_Reacq_0003(self):
        ...
        for loopId in range(1, 101):
            ...
            self.assertSuc(self.lbs.aw_startLocation('warm'))
    ...
    def teardown(self):
        super(BF_TTFF_static_roof_Reacq_0003, self).teardown()
