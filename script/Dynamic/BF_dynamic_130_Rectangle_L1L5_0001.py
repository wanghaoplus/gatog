...
# @Author  : wanghao
# @Site    : 
# @File    : BF_dynamic_130_Rectangle_L1L5_0001.py
# @Software: Eclipse
from aw.LbsTestCase import LbsTestCase


class BF_dynamic_130_Rectangle_L1L5_0001(LbsTestCase):

    def __init__(self):
        super(BF_dynamic_130_Rectangle_L1L5_0001, self).__init__()
        self.TestCaseList = ["BF_dynamic_130_Rectangle_L1L5_0001"]
        self.scenePath = ""

    def setup(self):
        super(BF_dynamic_130_Rectangle_L1L5_0001, self).setup()
        self.sceneFile = r'D:\posapp\Scenarios\Test Case\TestCase_For_Report\Rectangle_L1L5\Rectangle_L1L5.scn'
        self.sceneId = 'Rectangle_L1L5'
    ...
    def BF_dynamic_130_Rectangle_L1L5_0001(self):
    ...
    def teardown(self):
        super(BF_dynamic_130_Rectangle_L1L5_0001, self).teardown()
