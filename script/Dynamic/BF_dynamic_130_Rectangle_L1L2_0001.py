...
# @Author  : wanghao
# @Site    : 
# @File    : BF_dynamic_130_Rectangle_L1L2_0001.py
# @Software: Eclipse
from aw.LbsTestCase import LbsTestCase


class BF_dynamic_130_Rectangle_L1L2_0001(LbsTestCase):

    def __init__(self):
        super(BF_dynamic_130_Rectangle_L1L2_0001, self).__init__()
        self.TestCaseList = ["BF_dynamic_130_Rectangle_L1L2_0001"]
        self.scenePath = ""

    def setup(self):
        super(BF_dynamic_130_Rectangle_L1L2_0001, self).setup()
        self.sceneFile = r'D:\posapp\Scenarios\Test Case\TestCase_For_Report\Rectangle_L1\Rectangle_L1.scn'
        self.sceneId = 'Rectangle_L1'
    ...
    def BF_dynamic_130_Rectangle_L1L2_0001(self):
    ...
    def teardown(self):
        super(BF_dynamic_130_Rectangle_L1L2_0001, self).teardown()
