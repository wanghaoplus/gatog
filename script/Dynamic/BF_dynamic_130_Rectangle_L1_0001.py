...
# @Author  : wanghao
# @Site    : 
# @File    : BF_dynamic_130_Rectangle_L1_0001.py
# @Software: Eclipse
from aw.LbsTestCase import LbsTestCase


class BF_dynamic_130_Rectangle_L1_0001(LbsTestCase):

    def __init__(self):
        super(BF_dynamic_130_Rectangle_L1_0001, self).__init__()
        self.TestCaseList = ["BF_dynamic_130_Rectangle_L1_0001"]
        self.scenePath = ""

    def setup(self):
        super(BF_dynamic_130_Rectangle_L1_0001, self).setup()  
    ...
    def BF_dynamic_130_Rectangle_L1_0001(self):
    ...
    def teardown(self):
        super(BF_dynamic_130_Rectangle_L1_0001, self).teardown()
