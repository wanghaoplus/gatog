...
class BF_sensitivity_L1L2_Tracking_0001(LbsTestCase):

    def __init__(self):
        super(BF_sensitivity_L1L2_Tracking_0001, self).__init__()
        self.TestCaseList = ["BF_sensitivity_L1L2_Tracking_0001"]

    def setup(self):
        super(BF_sensitivity_L1L2_Tracking_0001, self).setup()
    ...
    def BF_sensitivity_L1L2_Tracking_0001(self):
    ...
    def teardown(self):
        super(BF_sensitivity_L1L2_Tracking_0001, self).teardown()
