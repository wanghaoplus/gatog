...
# @Site    : 
# @File    : BF_Special_MaxSpeed_L1L5_0001.py
# @Software: PyCharm
from aw.LbsTestCase import LbsTestCase


class BF_Special_MaxSpeed_L1L5_0001(LbsTestCase):

    def __init__(self):
        super(BF_Special_MaxSpeed_L1L5_0001, self).__init__()
        self.TestCaseList = ["BF_Special_MaxSpeed_L1L5_0001"]

    def setup(self):
        super(BF_Special_MaxSpeed_L1L5_0001, self).setup()
        self.sceneFile = r'D:\posapp\Scenarios\Test Case\TestCase_For_Report\maxspeed_L1L5\maxspeed_L1L5.scn'
        self.sceneId = 'maxspeed_L1L5'
        self.maxSpeed = 515
    ...
    def BF_Special_MaxSpeed_L1L5_0001(self):
        ...
        self.checkPoint("最大支持是否到515m/s，超过515m/s检查是否失去定位")
        self.assertSuc(self.lbs.aw_checkMaxSpeed(self.maxSpeed))

    def teardown(self):
        super(BF_Special_MaxSpeed_L1L5_0001, self).teardown()
