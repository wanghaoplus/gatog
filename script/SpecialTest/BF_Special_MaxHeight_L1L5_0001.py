...
# @Site    : 
# @File    : BF_Special_MaxHeight_L1L5_0001.py
# @Software: PyCharm
from aw.LbsTestCase import LbsTestCase


class BF_Special_MaxHeight_L1L5_0001(LbsTestCase):

    def __init__(self):
        super(BF_Special_MaxHeight_L1L5_0001, self).__init__()
        self.TestCaseList = ["BF_Special_MaxHeight_L1L5_0001"]

    def setup(self):
        super(BF_Special_MaxHeight_L1L5_0001, self).setup()
        self.sceneFile = r'D:\posapp\Scenarios\Test Case\TestCase_For_Report\maxheight_L1L5\maxheight_L1L5.scn'
        self.sceneId = 'maxheight_L1L5'
    ...
    def BF_Special_MaxHeight_L1L5_0001(self):
    ...
    def teardown(self):
        super(BF_Special_MaxHeight_L1L5_0001, self).teardown()
