...
class BF_Special_MaxSpeed_L1_0001(LbsTestCase):
    ...
    def setup(self):
        ...
        self.sceneFile = r'D:\posapp\Scenarios\Test Case\TestCase_For_Report\maxspeed_L1L5\maxspeed_L1.scn'
        self.sceneId = 'maxspeed_L1'
        self.maxHeight = 515
    ...
    def BF_Special_MaxSpeed_L1_0001(self):
        ...
        self.assertSuc(self.lbs.aw_checkMaxSpeed(self.maxHeight))
