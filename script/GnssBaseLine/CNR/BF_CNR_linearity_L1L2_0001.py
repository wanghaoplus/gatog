...
class BF_CNR_linearity_L1L2_0001(LbsTestCase):

    def __init__(self):
        super(BF_CNR_linearity_L1L2_0001, self).__init__()
        self.TestCaseList = ["BF_CNR_linearity_L1L2_0001"]

    def setup(self):
        super(BF_CNR_linearity_L1L2_0001, self).setup()
        self.sceneFile = r'D:\xxx\xx.scn'
        self.dbm = -120
        self.endDBM = -165
    ...
    def BF_CNR_linearity_L1L2_0001(self):
    ...
    def teardown(self):
        super(BF_CNR_linearity_L1L2_0001, self).teardown()
